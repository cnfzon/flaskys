...
> **PROJECT STATUS: DISCONTINUED** > This project has been officially canceled by the upstream sponsor (Project PI). Development is no longer active. The codebase represents the final POC (Proof of Concept) stage and is now publicly available under the **MIT License** for educational purposes or future handovers.
